...
<div class="upcoming-course">
  ...
  <?php endforeach; ?>
    ...
    <!-- <button onclick="openPopup('')">Enroll</button> -->
        ...
        <img src="../HomePimg/tulips-removebg-preview.png" class="flower-image2" alt="logo">
            ...
            <div class="payment-options">
              <label class="payment-option">
                ...
                <img src="../Courses page Images/wave pay.png" alt="Wave">
              </label>

              <label class="payment-option">
                <input type="radio" name="payment_method" value="paypal" hidden>
                <img src="../Courses page Images/paypal.png" alt="PayPal">
              </label>

              <label class="payment-option">
                <input type="radio" name="payment_method" value="kbzpay" hidden>
                <img src="../Courses page Images/kpay.png" alt="KBZPay">
              </label>
            </div>
...
<script>
  function openPopup(paymentName) {
